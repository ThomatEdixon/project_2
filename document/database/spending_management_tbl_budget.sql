...
CREATE TABLE `tbl_budget` (
  ...
  `type_currency` varchar(50) DEFAULT NULL,
  `balance` int NOT NULL,
  `save_date` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `tbl_budget_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`id`)
...
INSERT INTO `tbl_budget` VALUES (1,1,'VND',458500,'2023-01-27');
